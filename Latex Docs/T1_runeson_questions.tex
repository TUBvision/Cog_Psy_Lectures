...
\begin{center}
\textbf{\begin{LARGE}KOGW-PM-KNP: \\ \vspace{3mm} Tutorial 1 - Runeson's smart mechanisms                                                                          \end{LARGE}}
\end{center}
...
\begin{enumerate}
 ...
 \end{enumerate}
Go to the following website if you want to see a planimeter in action
