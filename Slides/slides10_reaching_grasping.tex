...
\item<2-> Rock and Harris, 1967: feel cube under cloth and see the same cube through minifying lens $\Rightarrow$ mismatch between felt and seen size
\end{itemize}

\begin{center}
\includegraphics[width=60mm]<3->{figs/l9/rock_harris_67.png}
\end{center}
\begin{itemize}
 \item<3-> vision dominated touch 
 \item<4-> vision less alerting than touch $\rightarrow$ more voluntary attention on vision
\end{itemize}
