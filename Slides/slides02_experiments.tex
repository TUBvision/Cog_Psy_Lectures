...
\begin{figure}
\begin{center}
   \includegraphics[width=75mm]{../../../figures/scientist_fool_nature15.png}
...
\only<2->{
\vspace{10mm}
... contains a number of statements which are not being tested with respect to their consistency or validity
}
\end{overlayarea}
\end{frame}
...
\vspace{4mm}
 \only<3->{
   \begin{itemize}
    ...
    \item<4->[!] common sense wisdom does not undergo critical testing with \textcolor{blue}{scientific methods}
   \end{itemize}
  }
\end{overlayarea}
\end{frame}
...
\begin{columns}[T]
 \begin{column}{65mm}
\begin{center}
\includegraphics<1-6>[width=65mm]{../../../figures/reproducibility_nature15_fallacies.jpg}
\includegraphics<7>[width=65mm]{../../../figures/reproducibility_nature15.jpg}
\end{center}
 \end{column}
 ...
 \begin{column}{50mm}
  \only<1-2>{
\begin{center}
\textcolor{blue}{Hypothesis myopia}
\begin{itemize}
 \item 1999 British woman guilty of murdering two of her sons
 \item relative likelihood of sudden infant death syndrome: 
 \item[] 1 out of 297.000 families
 \item<2> relative likelihood of double murder
 \item[]<2> 1 out of 2.7 m families 
\end{itemize}
\end{center}
}
  \only<3-4>{
\begin{center}
\textcolor{blue}{Texas sharpshooter}
\begin{itemize}
 \item fire random pattern of bullets
 \item[$\rightarrow$] draw bullseye around cluster 
 \item<4> p-hacking
\end{itemize}
\end{center}
}
  ...
  \only<5>{
\begin{center}
\textcolor{blue}{Asymmetric attention}
\begin{itemize}
 \item disconfirmation bias
 \item double checking of unexpected results
\end{itemize}
\end{center}
}
  ...
  \only<6>{
\begin{center}
\textcolor{blue}{Just-so storytelling}
\begin{itemize}
 \item how the leopard got its spots
...
\begin{frame}{Systemic biases in Science}
