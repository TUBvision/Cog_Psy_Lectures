...
Experiment on memory span:
 ...
 \item[$\Rightarrow$] Would people use the phonological loop to engage in verbal rehearsal doing \textit{subvocal articulation}?
 \end{itemize}
}
...
\begin{itemize}
 ...
 \item[$\Rightarrow$] individuals with low WM capacity had higher event-related potentials (ERPs) in response to \textbf{distracting stimuli} than individuals with high capacity 
\end{itemize}}
