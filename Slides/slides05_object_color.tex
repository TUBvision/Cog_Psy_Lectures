...
\vspace{5mm}
\only<1>{Kanizsa's illusory contours}
\only<2>{\textcolor{blue}{The perceptual whole is more than the sum of its parts}}
...
\only<3->{
\begin{itemize}
 \item[] stimuli that give rise to two or more interpretations of their identity or structure 
\end{itemize}
}
\end{overlayarea}
\end{frame}
